<nav class="bg-gray-800" x-data="{ isOpen: false }">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex items-center">
            ...
            {{-- <img class="size-8" src="D:\laragon\www\arima-app\public\logo.png" alt="Your Company"> --}}
            </div>
            ...
            <div class="ml-10 flex items-baseline space-x-4">
                ...
                <x-nav-link href="/forecasting" :active="request()->is('forecasting')">Forecasting</x-nav-link>
                <x-nav-link href="/about" :active="request()->is('about')">Next 12 months</x-nav-link>
            </div>
            </div>
        </div>
        <div class="hidden md:block">
    ...
    <div x-show="isOpen" class="md:hidden" id="mobile-menu">
        ...
        <div class="border-t border-gray-700 mt-2 pb-3 pt-4">
